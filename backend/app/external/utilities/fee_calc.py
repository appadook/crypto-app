...
class FeeCalculator:
    ...
    def __init__(self, exchange_buy, exchange_sell, crypto, crypto_amount, crypto_price_buy, crypto_price_sell, currency_withdrawal, withdrawal_method):
    ...
    def get_withdrawal_fee(self, exchange, currency_withdrawal, withdrawal_type, method=None, exchange_rate=1.0):
        ...
        fiat_fee = fees["fiat"][currency_withdrawal][method]
    ...
    def calculate_fees(self):
        ...
        withdrawal_fee = self.get_withdrawal_fee(self.exchange_sell, self.currency_withdrawal, withdrawal_type, self.withdrawal_method, 1.0429)
